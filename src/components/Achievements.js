...
export default function App() {
    ...
    <div className="w-full py-[4rem] px-4 bg-white border-b-4" id="achievements">
      <h1 className="flex justify-center md:text-4xl sm:text-3xl text-2xl font-bold py-2 font-mono line">Achievements</h1>
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-4 gap-8" data-aos="fade-up">
        ...
        <div className="bg-white w-full flex flex-col items-center p-4 my-4 rounded-lg border-black border-2 border-solid" data-aos="fade-up">
            <h2 className="text-5xl font-bold text-center py-8 text-[#007ea7]">5000+</h2>
        ...
        <div className="bg-white w-full flex flex-col items-center p-4 my-4 rounded-lg border-black border-2 border-solid" data-aos="fade-up">
            <h2 className="text-5xl font-bold text-center py-8 text-[#007ea7]">250+</h2>
